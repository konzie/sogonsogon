...
<body>
	<div class="container">
		...
		<div class="container pb-5 mb-5" id="content-main">
			...
			<!-- enctype="multipart/form-data" -->
				...
				<!--------------- 기존 이미지 배치 준비 부분  ---------------->
				<!--  기존 이미지를 서버에서 조회한 후 
						레벨별로 이미지 출력에 필요한 src 경로를 담은 변수를 생성할 예정. -->
				...
				<div class="form-inline mb-2">
					...
					<div class="boardImg" id="titleImgArea">
						...
						<%-- titleImgSrc변수가 만들어진 경우 
								== 기존 이미지 중 썸네일 이미지가 있는 경우
								-> img태그의 src 속성을 추가하고 
								속성값으로 titleImgSrc의 값을 작성하겠다. --%>
	...
	<script>
		...
		$(".deleteImg").on("click", function(event){
			// event 매개 변수 : 이벤트와 이벤트가 발새한 객체에 대한 모든 정보가 담겨 있음. 
			...
			// 이미지 태그자체를 삭제 시키고, 그자리에 새로운 이미지 태그를 추가 
			...
			//$(".deleteImg").index(this) 인 요소들 중 현재 요소 (this)의 인덱스 순서를 반환 
